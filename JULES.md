...
5. Docs truth pass — Files: README.md, SPEC.md, docs/*.md only. Update anything still saying "dream-cooling-crm" so docs describe the repo as it actually is. No invented status claims.
