...
- 2026-07-21 — Added test coverage for `api/nvidia.js` (NVIDIA AI proxy). Covered parsing strings, fallback models, missing keys, forced disabling stream, and upstream errors. Integrated it into `npm test`.
