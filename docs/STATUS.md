...
- 2026-07-21 — Added unit tests for the `stripHtml` function in `api/inbound-email.js` to ensure proper parsing of inbound email HTML bodies, and fixed test runner bugs for `test-inpage-merge.mjs`.
