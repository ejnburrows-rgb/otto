...
export function validateUnifiedIntake(source) {
  return [
    ...
    ['bridge precedes unified runtime', source.indexOf('data-otto-unified-intake-bridge') > -1 && source.indexOf('data-otto-unified-intake-bridge') < source.indexOf('data-otto-unified-intake')],
